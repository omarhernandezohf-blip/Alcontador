...
if menu == "Inicio / Dashboard":
    ...
    with c1:
        ...
        <div class='info-card'>
            ...
            <div class='info-title'>Auditoría Fiscal</div>
            <div class='info-text'>Cruces automáticos DIAN vs Contabilidad para evitar sanciones.</div>
        </div>
        """, unsafe_allow_html=True)
    ...
    with c2:
        ...
        <div class='info-card'>
            ...
            <div class='info-title'>Minería XML</div>
            <div class='info-text'>Extracción masiva de datos fiscales directamente de la fuente.</div>
        </div>
        """, unsafe_allow_html=True)
    ...
    with c3:
        ...
        <div class='info-card'>
            <span class='info-icon'>🤝</span>
            <div class='info-title'>Conciliación IA</div>
            <div class='info-text'>Matching bancario inteligente con lógica difusa.</div>
        </div>
        """, unsafe_allow_html=True)
    ...
    with c4:
        ...
        <div class='info-card'>
            <span class='info-icon'>📈</span>
            <div class='info-title'>Reportes NIIF</div>
            <div class='info-text'>Redacción automática experta de notas a estados financieros.</div>
        </div>
        """, unsafe_allow_html=True)
    ...
    with col_b:
        st.info("2. Generación: Crea tu API Key y configúrala en el sistema.")
    with col_c:
...
# ------------------------------------------------------------------------------
    ...
    if menu == "Auditoría Cruce DIAN":
        ...
        <div class='detail-box'>
            <strong>Objetivo:</strong> Detectar discrepancias entre lo que reportaste y lo que la DIAN sabe de ti.<br>
            <strong>Estrategia:</strong> Cruce matricial de NITs para evitar sanciones por inexactitud (Art. 651 ET).
        </div>
        """, unsafe_allow_html=True)
        ...
        if file_dian and file_conta:
            ...
            st.divider()
            st.info("⚙️ Configuración del Mapeo (Selecciona las columnas)")
            c1, c2, c3, c4 = st.columns(4)
