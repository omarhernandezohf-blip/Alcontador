...
# ==============================================================================
# 2.5. CONFIGURACIÓN DE SECRETOS (¡NUEVO!)
# ==============================================================================
import os
...
with st.sidebar:
    ...
    # Si no ha iniciado sesión, mostramos los campos de usuario/contraseña
    ...
    # Si YA inició sesión, mostramos su perfil y el menú
    else:
        # Tarjeta de Perfil
    ...
    # MENÚ DE NAVEGACIÓN (Siempre visible para que no rompa el código)
    opciones_menu = [
        "Inicio / Dashboard",
    ...
    # Si no está logueado, forzamos a que solo vea el Dashboard
    if not st.session_state.get('logged_in', False):
        menu = "Inicio / Dashboard"
    else:
        menu = st.radio("Módulos Operativos:", opciones_menu)
    
    st.markdown("<br><center><small style='color: #64748b;'>v12.0 Enterprise</small></center>", unsafe_allow_html=True)
# ==============================================================================
